...
public class Utility extends ManageDriver {
    ...
    public void mouseHoverToOneElementToSecondAndClick(WebElement one, WebElement second)
    {
        Actions actions=new Actions(driver);
        actions.moveToElement(one).moveToElement(second).click().build().perform();
    }
...
//***************************** Is Display Methods **********************************************//
    ...
    //To type text in textBox without sendKeys() method
    public void javaExecutorScriptExecuteScriptToTypeText(WebElement id,String text)
    {
        //js.executeScript("document.getElementById('id').value='text';");
        js.executeScript("document.getElementById("+id+").value='"+text+"'");
    }
    //To perform scroll vertically for 1000px
    public void javaExecutorScriptExecuteScriptToPerformScroll(WebElement window)
    {
    ...
    public void javaExecutorScriptExecuteScriptToHandleChkBox(WebElement id)
    {
        js.executeScript("document.getElementById("+id+").checked=false;");
    }
    //To refresh browser window
    public void javaExecutorScriptExecuteScriptToRefreshBrowserWindow()
    {
        js.executeScript("history.go(0)");
        //js.executeScript("location.reload()");
    }
    //To get the inner text of the entire webpage
    public void javaExecutorScriptExecuteScriptToGetInnerTxt()
    {
        String innerText = js.executeScript(" return document.documentElement.innerText;").toString();
        System.out.println(innerText);
    }
    //To generate an alert popup window
    public void javaExecutorScriptExecuteScriptToGenerateAlertPopUpWindow(String welMsg)
    {
        js.executeScript("alert("+welMsg+")");
    }
    ...
    //Date picker
    public void javaSelectDateByJS(WebElement element, String dateVal)
    {
